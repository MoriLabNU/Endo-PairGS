...
def l_ssim(img1, img2, window_size=11, size_average=True):
    channel = img1.size(-3)
...
class GradL1Loss(nn.Module):
    ...
    def forward(self, input, target, mask=None, interpolate=True, return_interpolated=False):
        ...
        # print(f"grad_gt: {grad_gt}, grad_pred: {grad_pred}")
        # print(grad_pred[0].shape)
        # print(grad_gt[0].shape)
        # print(grad_pred[1].shape)
        # print(torch.isnan(grad_gt[0]).any())
        # print(torch.isnan(grad_pred[0]).any())
        # print(mask_g.shape)
        ...
        # print(mask_mag)
        # print(grad_pred[0].mean())
        # print(grad_gt[0].mean())

...
session = ort.InferenceSession(
            'submodules/depth_anything/depth_anything_vits14.onnx', 
...
def main(args):    
    ...
    for i in img_list:
        ...
        # print(dam_depth.shape)
        # cv2.imwrite(os.path.join(dam_depth_dir, i), ((dam_depth[0] / np.max(dam_depth))*255).astype(np.uint8))

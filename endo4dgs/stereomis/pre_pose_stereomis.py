...
focal_length = 1042.49
h = 1024
w = 1280

raw_data_root = '/suedata1/Free/xkangyu/data/stereomis'
steps=2
data_dir = f'{raw_data_root}/StereoMIS_0_0_1/P3'
...
for i in range(start_index, start_index+img_range, steps):
    c_quat = quat[i]
    c_trans = trans[i]
    ...
    transformation_matrix[2, 4] = focal_length / 2
...
np.save(os.path.join(data_dir, f'poses_bounds_{start_index}_{start_index+img_range}_s{steps}.npy'), pose_list)
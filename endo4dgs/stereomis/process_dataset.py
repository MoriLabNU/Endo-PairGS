...
def process_one(dir_name):
    ...
    os.makedirs(os.path.join(data_dir, 'images_right'), exist_ok=True)
    ...
    while True:
        ...
        left_path = os.path.join(data_dir, f'images/{count_tring}.png')
        # left_path = os.path.join(data_dir, f'images_{split}/{count_tring}.png')
        right_path = os.path.join(data_dir, f'images_right/{count_tring}.png')
...
folder_list = sorted(glob(os.path.join('/suedata1/Free/xkangyu/data/stereomis/StereoMIS_0_0_1/', "P3")))

...
from .utils import change_ply_format
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["endonerf"](args.source_path, args.white_background, args.eval, args.use_pretrain, num_gaussians=args.num_gaussians, pcd_nums=args.init_pcd_nums)
    ...
    def save(self, iteration, stage):
        ...
        change_ply_format(os.path.join(point_cloud_path, "point_cloud.ply"))

...
class GaussianModel:
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2, abe_split=False):
        ...
        if abe_split:
            ...
            new_deformation_table = self._deformation_table[selected_pts_mask].repeat(BACK_N)
    ...
    def prune(self, max_grad, min_opacity, extent, max_screen_size):
        ...
        # prune_mask = torch.logical_or(prune_mask, grads_accum_mask)
    ...
    def densify(self, max_grad, min_opacity, extent, max_screen_size, density_threshold, displacement_scale, model_path=None, iteration=None, stage=None, n=2, abe=False):
        grads = self.xyz_gradient_accum / self.denom
        grads[grads.isnan()] = 0.0
        # print(grads.max())

        self.densify_and_clone(grads, max_grad, extent, density_threshold, displacement_scale, model_path, iteration, stage)
        self.densify_and_split(grads, max_grad, extent, N=n, abe_split=abe)
